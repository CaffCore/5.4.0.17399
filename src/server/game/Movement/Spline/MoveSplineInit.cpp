...
namespace Movement
{
    ...
    int32 MoveSplineInit::Launch()
    {
        ...
        PacketBuilder::WriteMonsterMove(move_spline, unit->GetGUID(), unit->GetTransGUID(), data);
    ...
    void MoveSplineInit::Stop()
    {
        ...
        PacketBuilder::WriteStopMovement(loc, unit->GetGUID(), unit->GetTransGUID(), args.splineId, data);
        unit->SendMessageToSet(&data, true);
    }
