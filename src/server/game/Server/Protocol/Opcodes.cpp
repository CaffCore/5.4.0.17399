...
/*Need Fix(Login issue)*/DEFINE_OPCODE_HANDLER(CMSG_SAVE_CUF_PROFILES,                       STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSaveCUFProfiles           );
	...
	//DEFINE_OPCODE_HANDLER(CMSG_VIEW_OBJECT,                             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleViewObject                );
	...
	DEFINE_OPCODE_HANDLER(SMSG_AUCTION_HELLO_REPONSE,                   STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
	...
	//DEFINE_OPCODE_HANDLER(SMSG_GUILD_MOTD,                              STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
