...
enum Opcodes
{
    ...
    CMSG_GAMEOBJ_REPORT_USE                           = 0x06DF,  
    CMSG_GAMEOBJ_USE                                  = 0x055F,  
    ...
    CMSG_GUILD_BANK_MONEY_WITHDRAWN_QUERY             = 0x03FC,
    ...
    CMSG_LFG_PARTY_LOCK_INFO_REQUEST                  = 0x0,  
    ...
    CMSG_REALM_CACHE                                  = 0x1899,  
    SMSG_REALM_CACHE                                  = 0x0,  
    ...
    CMSG_QUESTGIVER_QUERY_QUEST                       = 0x1F52,  
    ...
    MSG_MOVE_SET_WALK_MODE                            = 0x0138,  
    MSG_MOVE_SET_WALK_SPEED_CHEAT                     = 0x0,
    MSG_MOVE_START_ASCEND                             = 0x0430,  
    MSG_MOVE_START_BACKWARD                           = 0x0459,  
    MSG_MOVE_START_DESCEND                            = 0x0132,  
    MSG_MOVE_START_FORWARD                            = 0x041B,  
    MSG_MOVE_START_PITCH_DOWN                         = 0x093B,  
    MSG_MOVE_START_PITCH_UP                           = 0x0079,  
    MSG_MOVE_START_STRAFE_LEFT                        = 0x0873,  
    MSG_MOVE_START_STRAFE_RIGHT                       = 0x0C12,  
    MSG_MOVE_START_SWIM                               = 0x0871,  
    MSG_MOVE_START_TURN_LEFT                          = 0x011B,  
    MSG_MOVE_START_TURN_RIGHT                         = 0x0411,  
    MSG_MOVE_STOP                                     = 0x0570,  
    MSG_MOVE_STOP_ASCEND                              = 0x0012,  
    MSG_MOVE_STOP_PITCH                               = 0x0071,  
    MSG_MOVE_STOP_STRAFE                              = 0x0171,  
    MSG_MOVE_STOP_SWIM                                = 0x0578,  
    MSG_MOVE_STOP_TURN                                = 0x0530,  
    MSG_MOVE_TELEPORT                                 = 0x00D5,  
    MSG_MOVE_TELEPORT_ACK                             = 0x0978,  
    ...
    SMSG_ATTACKERSTATEUPDATE                          = 0x0540,  
    SMSG_ATTACKSTART                                  = 0x0403,  
    SMSG_ATTACKSTOP                                   = 0x1448,  
    ...
    SMSG_BATTLE_PET_DELETED                           = 0x0, 
    SMSG_BATTLE_PET_ERROR                             = 0x0, 
    SMSG_BATTLE_PET_HEALED                            = 0x0, 
    SMSG_BATTLE_PET_JOURNAL                           = 0x0, 
    SMSG_BATTLE_PET_JOURNAL_LOCK_ACQUIRED             = 0x0, 
    SMSG_BATTLE_PET_JOURNAL_LOCK_DENIED               = 0x0, 
    SMSG_BATTLE_PET_LICENSE_CHANGED                   = 0x0, 
    SMSG_BATTLE_PET_TRAP_LEVEL                        = 0x0, 
    SMSG_BATTLE_PET_UPDATES                           = 0x0, 
    CMSG_BATTLE_PET_SUMMON                            = 0x0, 
    CMSG_BATTLE_PET_TRAP                              = 0x0, 
    CMSG_BATTLE_PET_RENAME                            = 0x0, 
    CMSG_BATTLE_PET_TOGGLE_FAVORITE                   = 0x0, 
	SMSG_BLACK_MARKET_HELLO                           = 0x0,  
    SMSG_BLACK_MARKET_REQUEST_ITEMS_RESULT			  = 0x0,  
    SMSG_BLACK_MARKET_BID_RESULT                      = 0x0,  
    SMSG_BLACK_MARKET_OUT_BID                         = 0x0,  
    SMSG_BLACK_MARKET_BID_WON                         = 0x0,  
    SMSG_BINDER_CONFIRM                               = 0x0F22,  
    SMSG_BINDPOINTUPDATE                              = 0x11E2,  
    ...
    SMSG_CLIENTCACHE_VERSION                          = 0x1E41,  
    ...
    SMSG_GROUP_LIST                                   = 0x1E61, 
    SMSG_GROUP_SET_LEADER                             = 0x15A2, 
    SMSG_GROUP_SET_ROLE                               = 0x0890, 
    ...
    SMSG_PLAYERBOUND                                  = 0x00E8,  
    SMSG_PLAYER_DIFFICULTY_CHANGE                     = 0x0,  
    SMSG_PLAYER_MOVE                                  = 0x1CB2,  
