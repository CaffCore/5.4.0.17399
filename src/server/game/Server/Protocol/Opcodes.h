...
enum Opcodes
{
    ...
    CMSG_MINIMAP_PING                                 = 0x0,  
    SMSG_MINIMAP_PONG                                 = 0x0,  
    ...
    CMSG_RAID_READY_CHECK                             = 0x0,  
    SMSG_RAID_READY_CHECK_STARTED                     = 0x0,  
