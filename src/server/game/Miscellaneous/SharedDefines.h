...
enum SpellCastResult
{
    ...
    SPELL_FAILED_UNKNOWN                        = 218, // custom value, default case
...
{
    ATTACKSWING_ERROR_UNK1                = 0,
    ATTACKSWING_ERROR_UNK2                = 1,
    ATTACKSWING_ERROR_BADFACING           = 2,
    ATTACKSWING_ERROR_NOTINRANGE          = 3
};
...
enum TradeStatus
{
    TRADE_STATUS_OPEN_WINDOW = 21,          /// 17128
    // 1 - Related to EVENT_PLAYER_MONEY
    TRADE_STATUS_NOT_ELIGIBLE = 5,          /// 17128 // Related to trading soulbound loot items
    TRADE_STATUS_YOU_LOGOUT = 3,
    TRADE_STATUS_IGNORE_YOU = 4,            /// 17128
    TRADE_STATUS_TARGET_DEAD = 5,
    TRADE_STATUS_TRADE_ACCEPT = 1,          /// 17128
    TRADE_STATUS_TARGET_LOGOUT = 7,         /// 17128
    // 8 - nonexistent
    TRADE_STATUS_TRADE_COMPLETE = 9,
    TRADE_STATUS_TRIAL_ACCOUNT = 9,         /// 17128 // Trial accounts can not perform that action
    // 11 - nonexistent
    TRADE_STATUS_BEGIN_TRADE = 12,          /// 17128
    TRADE_STATUS_YOU_DEAD = 13,             /// 17128
    // 14 - nonexistent
    // 15 - nonexistent
    TRADE_STATUS_TARGET_TO_FAR = 16,
    TRADE_STATUS_NO_TARGET = 17,            /// 17128
    TRADE_STATUS_BUSY_2 = 18,               /// 17128
    TRADE_STATUS_CURRENCY_NOT_TRADABLE = 22,/// 17128 // new 4.x
    TRADE_STATUS_WRONG_FACTION = 20,
    TRADE_STATUS_BUSY = 21,
    // 22 - equivalent to 335 unk status 9
    TRADE_STATUS_TRADE_CANCELED = 20,       /// 17128
    TRADE_STATUS_CURRENCY = 3,              /// 17128 // new 4.x
    TRADE_STATUS_BACK_TO_TRADE = 16,        /// 17128
    TRADE_STATUS_ONLY_CONJURED = 30,        /// 17128 // You can only trade conjured items... (cross realm BG related).
    TRADE_STATUS_YOU_STUNNED = 27,          /// 17128
    // 28 - nonexistent
    TRADE_STATUS_TARGET_STUNNED = 29,       /// 17128
    // 30 - nonexistent
    TRADE_STATUS_CLOSE_WINDOW = 15,         /// 17128
};
